    ...
    public class Recommendation
    {
        ...
        public static Recommendation FromLiElement(string liElement){
            ...
            if (videoContent.Success) {
                string content = videoContent.Value;
                ...
                string viewsStr = Regex.Match(content,
            ...
            int videoCount;
            if (videos.EndsWith("+")) videoCount = int.MaxValue;
            else videoCount = int.Parse(videos.Substring(0, videos.Length - 1));
